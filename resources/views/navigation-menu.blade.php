@php
    $isListerPortal = request()->routeIs('lister.*', 'my-listings', 'add-item', 'edit-item', 'rental-requests.*', 'rent-inventory-management')
        || (
...
<div>
    <aside
        class="fixed inset-y-0 left-0 z-50 hidden border-r border-slate-200 bg-white/95 px-5 py-6 shadow-xl shadow-slate-900/5 backdrop-blur-xl transition-all duration-300 dark:border-slate-800 dark:bg-slate-950/95 lg:flex lg:flex-col"
    ...
    <header
        class="fixed right-0 top-0 z-40 hidden h-16 items-center justify-between border-b border-slate-200/80 bg-white/90 px-8 shadow-sm shadow-slate-900/5 backdrop-blur-xl transition-all duration-300 dark:border-slate-800 dark:bg-slate-950/90 lg:flex"
    ...
    <nav x-data="{ open: false }" class="sticky top-0 z-40 border-b border-slate-200/80 bg-white/90 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/90 lg:hidden">
        <div class="flex h-16 items-center justify-between px-4">
            ...
            <button @click="open = !open" class="rounded-md p-2 text-slate-500 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-900">
...
<nav x-data="{ open: false }" class="sticky top-0 z-50 border-b border-slate-200/80 bg-white/85 backdrop-blur-xl dark:border-slate-700/80 dark:bg-slate-900/85">
    ...
    <div x-show="open" x-cloak class="border-t border-slate-200 bg-white px-4 py-3 sm:hidden dark:border-slate-700 dark:bg-slate-900">
        <div class="space-y-2 text-sm">
                ...
                <div class="space-y-2 rounded-2xl bg-slate-50 p-2 ring-1 ring-slate-200 dark:bg-slate-800 dark:ring-slate-700">
                    ...
                    @else
                        @if ($isListerPortal)
                            ...
                            <a href="{{ route('lister.my-listings') }}" class="{{ request()->routeIs('lister.my-listings', 'my-listings', 'add-item', 'edit-item', 'rental-requests.*') ? 'bg-gradient-to-r from-blue-600 to-violet-600 text-white' : 'text-slate-600 hover:bg-white hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-700 dark:hover:text-slate-100' }} flex items-center gap-3 rounded-xl px-4 py-3 font-semibold transition">
                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></svg>
                                My Listings
                            </a>
                            <a href="{{ route('lister.inventory') }}" class="{{ request()->routeIs('lister.inventory', 'rent-inventory-management') ? 'bg-gradient-to-r from-blue-600 to-violet-600 text-white' : 'text-slate-600 hover:bg-white hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-700 dark:hover:text-slate-100' }} flex items-center gap-3 rounded-xl px-4 py-3 font-semibold transition">
                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2z" /></svg>
                                Inventory
                            </a>
                        @else
                            <a href="{{ route('renter.dashboard') }}" class="{{ request()->routeIs('dashboard', 'renter.dashboard') ? 'bg-gradient-to-r from-blue-600 to-violet-600 text-white' : 'text-slate-600 hover:bg-white hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-700 dark:hover:text-slate-100' }} flex items-center gap-3 rounded-xl px-4 py-3 font-semibold transition">
                            ...
                            <a href="{{ route('renter.marketplace') }}" class="{{ request()->routeIs('home', 'renter.marketplace', 'categories.show', 'item.view') ? 'bg-gradient-to-r from-blue-600 to-violet-600 text-white' : 'text-slate-600 hover:bg-white hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-700 dark:hover:text-slate-100' }} flex items-center gap-3 rounded-xl px-4 py-3 font-semibold transition">
                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 0 0-8 0v4M5 9h14l1 12H4L5 9z" /></svg>
                                Marketplace
                            </a>
                            <a href="{{ route('renter.my-rentals') }}" class="{{ request()->routeIs('my-rentals', 'renter.my-rentals') ? 'bg-gradient-to-r from-blue-600 to-violet-600 text-white' : 'text-slate-600 hover:bg-white hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-700 dark:hover:text-slate-100' }} flex items-center gap-3 rounded-xl px-4 py-3 font-semibold transition">
                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2z" /></svg>
            ...
            @else
                <a href="{{ route('login.options') }}" class="block py-2 font-medium text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100">Sign In</a>
